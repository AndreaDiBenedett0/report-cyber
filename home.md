...
* [[1]](#part1) [Log in with the administrator’s user account](https://pwning.owasp-juice.shop/companion-guide/latest/appendix/solutions.html#_log_in_with_the_administrators_user_account), 
...
## Implementation 
### [1] <a id="part1"></a> Log in with the administrator’s user account
